...
RegisterServerEvent('esx_statetrooper:confiscatePlayerItem')
AddEventHandler('esx_statetrooper:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if sourceXPlayer.job.name ~= 'statetrooper' then
		print(('esx_statetrooper: %s attempted to confiscate!'):format(xPlayer.identifier))
		return
	end
...
RegisterServerEvent('esx_statetrooper:handcuff')
AddEventHandler('esx_statetrooper:handcuff', function(target)
	...
	if xPlayer.job.name == 'statetrooper' then
		...
		print(('esx_statetrooper: %s attempted to handcuff a player (not a bounty hunter)!'):format(xPlayer.identifier))
	end
end)

RegisterServerEvent('esx_statetrooper:drag')
AddEventHandler('esx_statetrooper:drag', function(target)
	...
	if xPlayer.job.name == 'statetrooper' then
		...
		print(('esx_statetrooper: %s attempted to drag (not not a bounty hunter)!'):format(xPlayer.identifier))
	end
end)

RegisterServerEvent('esx_statetrooper:putInVehicle')
AddEventHandler('esx_statetrooper:putInVehicle', function(target)
	...
	if xPlayer.job.name == 'statetrooper' then
		...
		print(('esx_statetrooper: %s attempted to put in vehicle (not not a bounty hunter)!'):format(xPlayer.identifier))
	end
end)

RegisterServerEvent('esx_statetrooper:OutVehicle')
AddEventHandler('esx_statetrooper:OutVehicle', function(target)
	...
	if xPlayer.job.name == 'statetrooper' then
		...
		print(('esx_statetrooper: %s attempted to drag out from vehicle (not not a bounty hunter)!'):format(xPlayer.identifier))
	end
end)

RegisterServerEvent('esx_statetrooper:getStockItem')
...
RegisterServerEvent('esx_statetrooper:putStockItems')
...
ESX.RegisterServerCallback('esx_statetrooper:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('esx_statetrooper:getVehicleFromPlate', function(source, cb, plate)
	MySQL.Async.fetchAll('SELECT owner FROM owned_vehicles WHERE plate = @plate', {
		['@plate'] = plate
	}, function(result)
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		if xPlayer ~= nil and xPlayer.job ~= nil and xPlayer.job.name == 'statetrooper' then
			Citizen.Wait(5000)
...
RegisterServerEvent('esx_statetrooper:spawned')
...
RegisterServerEvent('esx_statetrooper:forceBlip')
...
RegisterServerEvent('esx_statetrooper:message')
AddEventHandler('esx_statetrooper:message', function(target, msg)
